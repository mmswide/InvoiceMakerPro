...
@interface CreateObjectiveVC () <UITextViewDelegate>

@end

@implementation CreateObjectiveVC
...
-(id)initWithDelegate:(id<ObjectiveCreatorDelegate>)sender
{
	...
	{
		delegate = sender;
		theObjective = [[NSMutableString alloc] initWithString:@""];
...
-(void)done:(UIButton*)sender
{
	...
	if (delegate && [delegate respondsToSelector:@selector(creatorViewController:createdObjective:)])
	{
		[delegate creatorViewController:self createdObjective:theObjective];
	}
