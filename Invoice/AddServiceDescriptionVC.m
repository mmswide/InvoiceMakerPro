...
@interface AddServiceDescriptionVC () <UITextViewDelegate>

@end

@implementation AddServiceDescriptionVC
...
-(void)viewDidLoad
{
	...
	topBarView = [[TopBar alloc] initWithFrame:CGRectMake(0, 0, dvc_width, 42 + statusBarHeight) andTitle:@"Service Description"];
	...
	[textView setText:[theService note]];
...
{
	[theService setNote:((UITextView*)[self.view viewWithTag:888]).text];
