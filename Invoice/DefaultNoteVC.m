...
@interface DefaultNoteVC () <UITextViewDelegate>

@end

@implementation DefaultNoteVC
...
-(void)viewDidLoad
{
	...
	UIImageView * bgForText = [[UIImageView alloc] initWithFrame:CGRectMake(10, 52, dvc_width - 20, 200)];
	...
	UITextView * textView = [[UITextView alloc] initWithFrame:CGRectMake(15, 57, dvc_width - 30, 190)];
	...
	if (settingsDictionary && [[settingsDictionary allKeys] containsObject:@"defaultNote"] && [settingsDictionary objectForKey:@"defaultNote"])
	{
		[textView setText:[settingsDictionary objectForKey:@"defaultNote"]];
	}
...
-(void)done:(UIButton*)sender
{
	...
	[settingsDictionary setObject:((UITextView*)[self.view viewWithTag:888]).text forKey:@"defaultNote"];
