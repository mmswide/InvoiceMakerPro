...
@interface ProjectsVC () <UITableViewDataSource,UITableViewDelegate,ProjectCreatorDelegate,CategorySelectDelegate>
...
-(void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath
{
	...
	int index = (int)[array_with_projects indexOfObject:project];
	
	ProjectDetailVC *detailView = [[ProjectDetailVC alloc] initWithProject:project andIndex:index];
