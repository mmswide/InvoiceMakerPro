...
@implementation PurchaseOrderOBJ
...
-(id)init
{
	...
	if (self)
	{
		...
		[self setID:[data_manager createPurchaseOrderID]];
		[contents setObject:kPurTitle forKey:@"title"];
		[self setName:@""];
		[self setClient:[[[ClientOBJ alloc] init] contentsDictionary]];
    [self setClientBillingTitleforKey:kPurchaseBillingAddressTitleKeyForNSUserDefaults
		...
		[self setNote:PURCHASE_ORDER_FIRST_PAGE_NOTE];
		[self setBigNote:PURCHASE_ORDER_SECOND_PAGE_NOTE];
    
		[self setOtherCommentsTitle:PURCHASE_ORDER_OTHER_COMMENTS_TITLE];
		[self setOtherCommentsText:PURCHASE_ORDER_OTHER_COMMENTS_TEXT];
    
    [self setRightSignatureTitle:PURCHASE_ORDER_RIGHT_SIGNATURE_TITLE];
    [self setRightSignatureDate:[date_formatter dateFromString:[date_formatter stringFromDate:[NSDate date]]]];
		[self setRightSignature:[UIImage imageWithContentsOfFile:[NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@",PURCHASE_ORDER_RIGHT_SIGNATURE_PATH]]];
		[self setRightSignatureFrame:PURCHASE_ORDER_RIGHT_FRAME];
    
    [self setLeftSignatureTitle:PURCHASE_ORDER_LEFT_SIGNATURE_TITLE];
    [self setLeftSignatureDate:[date_formatter dateFromString:[date_formatter stringFromDate:[NSDate date]]]];
		[self setLeftSignature:[UIImage imageWithContentsOfFile:[NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@",PURCHASE_ORDER_LEFT_SIGNATURE_PATH]]];
		[self setLeftSignatureFrame:PURCHASE_ORDER_LEFT_FRAME];
...
-(id)initWithPO:(PurchaseOrderOBJ*)sender
{
    ...
    [date_formatter setDateFormat:[DELEGATE userSelectedDateFormat]];
		...
		if (sender && [sender isKindOfClass:[PurchaseOrderOBJ class]])
		{
...
- (NSArray *)localFigureSettings {
    return [data_manager purchaseFigureSettings];
}

- (void)saveFigureSettings {
    [data_manager setPurchaseFiguresSettings:[self figuresSettings]];
}

#pragma mark - Detals settings methods
...
- (NSArray *)localDetailsSettings {
    ...
    if([self areFiguresSettingsInDetailsFile]) {
      [data_manager setPurchaseDetailsSettings:[self newDetailsSettings]];
    }
  
    return [data_manager purchaseDetailsSettings];
}

- (void)saveDetailsSettings {
    [data_manager setPurchaseDetailsSettings:[self detailsSettings]];
}

- (void)setAndSaveDetailsSettings:(NSArray *)details {
  [data_manager setPurchaseDetailsSettings:details];
}

#pragma mark - AddItem Details settings methods

- (NSArray *)localAddItemDetailsSettings {
  return [data_manager purchaseAddItemDetailsSettings];
}

- (void)saveAddItemDetailsSettings {
    [data_manager setPurchaseAddItemDetailsSettings:[self addItemDetailsSettings]];
}

- (void)setAndSaveAddItemDetailsSettings:(NSArray *)settings {
  [data_manager setPurchaseAddItemDetailsSettings:settings];
}

#pragma mark - Profile settings methods

- (NSArray *)localProfileSettings {
  return [data_manager purchaseProfileSettings];
}

- (void)saveProfileSettings {
  [data_manager setPurchaseProfileSettings:[self profileSettings]];
}

#pragma mark - Client settings methods
- (NSArray *)localClientSettings {
  return [data_manager purchaseDetailsClientSettings];
}

- (void)saveClientSettings {
  [data_manager setPurchaseClientDetailsSettings:[self clientSettings]];
}
...
-(NSString*)title
{
	...
	{
		[data_manager logGetterErrorFromClass:[self class] forProperty:@"title" containedValue:[contents objectForKey:@"title"] withDefautReturnValue:kPurTitle];
		return kPurTitle;
	}
}
...
-(NSString*)note
{
	...
	else
	{
		...
		return PURCHASE_ORDER_FIRST_PAGE_NOTE;
	}
}
...
-(NSString*)bigNote
{
	...
	else
	{
		...
		return PURCHASE_ORDER_SECOND_PAGE_NOTE;
	}
}
...
-(NSString*)otherCommentsTitle
{
	...
	else
	{
		...
		return PURCHASE_ORDER_OTHER_COMMENTS_TITLE;
	}
}
...
-(NSString*)otherCommentsText
{
	...
	else
	{
		...
		return PURCHASE_ORDER_OTHER_COMMENTS_TEXT;
	}
}
...
-(NSString*)rightSignatureTitle
{
	...
	else
	{
		...
		return PURCHASE_ORDER_RIGHT_SIGNATURE_TITLE;
	}
}
...
-(UIImage*)rightSignature
{
	...
	else
	{
		...
		return [UIImage imageWithContentsOfFile:[NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@",PURCHASE_ORDER_RIGHT_SIGNATURE_PATH]];
	}
}
...
-(CGRect)rightSignatureFrame
{
	...
	else
	{
		...
		return PURCHASE_ORDER_RIGHT_FRAME;
	}
}
...
-(NSString*)leftSignatureTitle
{
	...
	else
	{
		...
		return PURCHASE_ORDER_LEFT_SIGNATURE_TITLE;
	}
}
...
-(UIImage*)leftSignature
{
	...
	else
	{
		...
		return [UIImage imageWithContentsOfFile:[NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@",PURCHASE_ORDER_LEFT_SIGNATURE_PATH]];
	}
}
...
-(CGRect)leftSignatureFrame
{
	...
	else
	{
		...
		return PURCHASE_ORDER_LEFT_FRAME;
	}
}
...
-(void)setTitle:(NSString*)sender
{
	if (sender && [sender isKindOfClass:[NSString class]])
	{
		[CustomDefaults setCustomObjects:sender forKey:kPurchaseOrderTitleKeyForNSUserDefaults];
		...
		NSMutableDictionary *purchaseDict = [[NSMutableDictionary alloc] initWithDictionary:[languageDict objectForKey:@"purchase"]];
		[purchaseDict setObject:sender forKey:@"Purchase Order"];
	...
	{
		[data_manager logSetterErrorFromClass:[self class] forProperty:@"title" sentValue:sender withDefaultSetValue:kPurTitle];
		[contents setObject:kPurTitle forKey:@"title"];
	}
}
...
- (void)saveNote:(NSString *)sender {
  if (sender && [sender isKindOfClass:[NSString class]]) {
    [CustomDefaults setCustomString:sender forKey:PURCHASE_ORDER_FIRST_PAGE_NOTE_KEY];
  }
}
...
- (void)saveBigNote:(NSString *)sender {
  if (sender && [sender isKindOfClass:[NSString class]])
  {
    ...
    {
      [CustomDefaults setCustomString:sender forKey:PURCHASE_ORDER_SECOND_PAGE_NOTE_KEY];
    }
  }
}
...
- (void)saveOtherCommentsTitle:(NSString *)sender {
  if (sender && [sender isKindOfClass:[NSString class]])
  {
    [CustomDefaults setCustomString:sender forKey:PURCHASE_ORDER_OTHER_COMMENTS_TITLE_KEY];
  }
}
...
- (void)saveOtherCommentsText:(NSString *)sender {
  if (sender && [sender isKindOfClass:[NSString class]])
  {
    [CustomDefaults setCustomString:sender forKey:PURCHASE_ORDER_OTHER_COMMENTS_TEXT_KEY];
  }
}
...
- (void)saveRightSignatureTitle:(NSString *)sender {
  if (sender && [sender isKindOfClass:[NSString class]])
  {
    [CustomDefaults setCustomString:sender forKey:PURCHASE_ORDER_RIGHT_SIGNATURE_TITLE_KEY];
  }
}
...
- (void)setRightSignature:(UIImage *)sender andSave:(BOOL)save {
  ...
  if(save) {
    [CustomDefaults setCustomString:MD5 forKey:PURCHASE_ORDER_RIGHT_SIGNATURE_PATH_KEY];
  } else {
...
-(void)removeRightSignatureImageAndSave:(BOOL)save {
  ...
  if((![signFilePath isEqualToString:PURCHASE_ORDER_RIGHT_SIGNATURE_PATH] && !save) || save) {
    NSString *imagePath = save?PURCHASE_ORDER_RIGHT_SIGNATURE_PATH:signFilePath;
  ...
  if(save) {
    [CustomDefaults setCustomString:@"" forKey:PURCHASE_ORDER_RIGHT_SIGNATURE_PATH_KEY];
  } else {
...
- (void)saveRightSignatureFrame:(CGRect)sender {
  [CustomDefaults setCustomObjects:[NSKeyedArchiver archivedDataWithRootObject:[NSValue valueWithCGRect:sender]] forKey:PURCHASE_ORDER_RIGHT_FRAME_KEY];
}
...
- (void)saveLeftSignatureTitle:(NSString *)sender {
  if (sender && [sender isKindOfClass:[NSString class]])
  {
    [CustomDefaults setCustomString:sender forKey:PURCHASE_ORDER_LEFT_SIGNATURE_TITLE_KEY];
  }
}
...
- (void)setLeftSignature:(UIImage *)sender andSave:(BOOL)save {
  ...
  if(save) {
    [CustomDefaults setCustomString:MD5 forKey:PURCHASE_ORDER_LEFT_SIGNATURE_PATH_KEY];
  } else {
...
-(void)removeLeftSignatureImageAndSave:(BOOL)save {
  ...
  if((![signFilePath isEqualToString:PURCHASE_ORDER_LEFT_SIGNATURE_PATH] && !save) || save) {
    NSString *imagePath = save?PURCHASE_ORDER_LEFT_SIGNATURE_PATH:signFilePath;
    NSString *filePath = [NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@",imagePath];
  ...
  if(save) {
    [CustomDefaults setCustomString:@"" forKey:PURCHASE_ORDER_LEFT_SIGNATURE_PATH_KEY];
  } else {
...
- (void)saveLeftSignatureFrame:(CGRect)sender {
  [CustomDefaults setCustomObjects:[NSKeyedArchiver archivedDataWithRootObject:[NSValue valueWithCGRect:sender]] forKey:PURCHASE_ORDER_LEFT_FRAME_KEY];
}
