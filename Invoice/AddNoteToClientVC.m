...
@interface AddNoteToClientVC () <UITextViewDelegate>

@end

@implementation AddNoteToClientVC
...
-(void)viewDidLoad
{
	...
	topBarView = [[TopBar alloc] initWithFrame:CGRectMake(0, 0, dvc_width, 42 + statusBarHeight) andTitle:@"Note"];
	...
	[textView setText:[theClient note]];
...
{
	[theClient setNote:[(UITextView*)[self.view viewWithTag:888] text]];
