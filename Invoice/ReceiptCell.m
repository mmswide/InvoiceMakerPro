...
-(void)loadReceipt:(ReceiptOBJ*)sender withCellType:(kCellType)type
{
	...
	[titleLabel setText:[sender category]];
	[nameLabel setText:[NSString stringWithFormat:@"%@ %@", [theClient firstName], [theClient lastName]]];
	
	NSString *priceValue = [data_manager currencyAdjustedValue:[sender getTotal] forSign:[sender sign]];
